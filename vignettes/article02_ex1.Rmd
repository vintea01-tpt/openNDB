...
```{r}
library(openNDB)
data <- suppressMessages(tidy_syohouyaku_sex_age("../NDBdata/original/naifuku_gairai_ingai_sex_age.xlsx"))

# or load parquet file
# data <- read_parquet("../NDBdata/apache/naifuku_gairai_ingai_sex_age.parquet")
